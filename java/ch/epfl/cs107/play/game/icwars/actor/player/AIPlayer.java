...
//                break;
//            case MOVE_UNIT:
//                System.out.println("je suis à move Unit hehe");
//                System.out.println("Avant de lui dire de changer de position : " +
//                        selectedUnitAi.getPosition().x + " " + selectedUnitAi.getPosition().y);
//                selectedUnitAi.changePosition(newCoords(coordsNearestUnit));
//                DiscreteCoordinates coordinates = newCoords(coordsNearestUnit);
//                System.out.println("Nouvelle position normalement : " + coordinates.x + " " + coordinates.y );
//                setCurrentPosition(selectedUnitAi.getPosition());
//                if(waitFor(2,dt)) {
//                    currentState = playerState.ACTION;
//                }
